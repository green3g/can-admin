...
(function (l, f) {
    function m () {
        var a = e.elements; return typeof a === 'string' ? a.split(' ') : a; 
    } function i (a) {
        var b = n[a[o]]; b || (b = {}, h++, a[o] = h, n[h] = b); return b;
    } function p (a, b, c) {
        b || (b = f); if (g) {
            return b.createElement(a);
        } c || (c = i(b)); b = c.cache[a] ? c.cache[a].cloneNode() : r.test(a) ? (c.cache[a] = c.createElem(a)).cloneNode() : c.createElem(a); return b.canHaveChildren && !s.test(a) ? c.frag.appendChild(b) : b;
    } function t (a, b) {
        if (!b.cache) {
        ...
        a || (a = f); var b = i(a); if (e.shivCSS && !j && !b.hasCSS) {
            ...
            c = d.insertBefore(c.lastChild, d.firstChild); b.hasCSS = Boolean(c);
        }g || t(a, b); return a; 

!(function () {
        ...
        function S (a) {
            function d (e) {
                var b = e.charCodeAt(0); if (b !== 92) {
                    return b;
                } var a = e.charAt(1); return (b = r[a]) ? b : a >= '0' && a <= '7' ? parseInt(e.substring(1), 8) : a === 'u' || a === 'x' ? parseInt(e.substring(2), 16) : e.charCodeAt(1); 
            } function g (e) {
                if (e < 32) {
    ...
    h = b[a], c.push(g(h[0])),
		h[1] > h[0] && (h[1] + 1 > h[0] && c.push('-'), c.push(g(h[1])));
                ...
                for (var a = e.source.match(/\[(?:[^\\\]]|\\[\S\s])*]|\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\\d+|\\[^\dux]|\(\?[!:=]|[()^]|[^()[\\^]+/g), c = a.length, d = [], f = 0, h = 0; f < c; ++f) {
                    var l = a[f]; l === '(' ? ++h : l.charAt(0) === '\\' && (l = Number(l.substring(1))) && (l <= h ? d[l] = -1 : a[f] = g(l)); 
                } for (f = 1; f < d.length; ++f) {
                    d[f] === -1 && (d[f] = ++x); 
                } for (h = f = 0; f < c; ++f) {
                    l = a[f], l === '(' ? (++h, d[h] || (a[f] = '(?:')) : l.charAt(0) === '\\' && (l = Number(l.substring(1))) && l <= h &&
		(a[f] = '\\' + d[l]);
                } for (f = 0; f < c; ++f) {
                    a[f] === '^' && a[f + 1] !== '^' && (a[f] = ''); 
                } if (e.ignoreCase && m) {
                ...
                var c = a.nodeType; if (c == 1) {
                    if (!b.test(a.className)) {
                        for (c = a.firstChild; c; c = c.nextSibling) {
                            g(c); 
                        }c = a.nodeName.toLowerCase(); if (c === 'br' || c === 'li') {
                            s[j] = '\n', m[j << 1] = x++, m[j++ << 1 | 1] = a;
                        }
                    }
                } else if (c == 3 || c == 4) {
            ...
            function g (a) {
                for (var j = a.e, k = [j, 'pln'], c = 0, i = a.a.match(s) || [], r = {}, n = 0, e = i.length; n < e; ++n) {
                    var z = i[n], w = r[z], t = void 0, f; if (typeof w === 'string') {
                        ...
                        } if ((f = w.length >= 5 && w.substring(0, 5) === 'lang-') && !(t && typeof t[1] === 'string')) {
                            f = !1, w = 'src'; 
                        }f || (r[z] = w); 
                    }h = c; c += z.length; if (f) {
    ...
    for (var e = n.length; --e >= 0;) {
...
}r = r[1]; n = String(r); k.hasOwnProperty(n) || (j.push(r), k[n] = q); 
                }j.push(/[\S\s]/); s = S(j);
		...
		s + ')*(?:\\x5D|$))+/') + ')')]); 
                    }(b = a.types) && g.push(['typ', b]); b = (String(a.keywords)).replace(/^ | $/g, ''); b.length && g.push(['kwd', RegExp('^(?:' + b.replace(/[\s,]+/g, '|') + ')\\b'), q]); d.push(['pln', /^\s+/, q, ' \r\n\t\u00a0']); b = '^.[^\\s\\w.$@\'"`/\\\\]*'; a.regexLiterals && (b += '(?!s*/)'); g.push(['lit', /^@[$_a-z][\w$@]*/i, q], ['typ', /^(?:[@_]?[A-Z]+[a-z][\w$@]*|\w+_t\b)/, q], ['pln', /^[$_a-z][\w$@]*/i, q], ['lit', /^(?:0x[\da-f]+|(?:\d(?:_\d+)*\d*(?:\.\d*)?|\.\d\+)(?:e[+-]?\d+)?)[a-z]*/i, q, '0123456789'], ['pln', /^\\[\S\s]?/,
        ...
        p(C([], [['str', /^[\S\s]+/]]), ['regex']); var Y = D.PR = {createSimpleLexer: C, registerLangHandler: p, sourceDecorator: v, PR_ATTRIB_NAME: 'atn', PR_ATTRIB_VALUE: 'atv', PR_COMMENT: 'com', PR_DECLARATION: 'dec', PR_KEYWORD: 'kwd', PR_LITERAL: 'lit', PR_NOCODE: 'nocode', PR_PLAIN: 'pln', PR_PUNCTUATION: 'pun', PR_SOURCE: 'src', PR_STRING: 'str', PR_TAG: 'tag', PR_TYPE: 'typ', prettyPrintOne: D.prettyPrintOne = function (a, d, g) {
			...
			o.className && e.test(o.className)) {
                            ...
                            d.className += ' prettyprinted'; m = j.lang; if (!m) {
                                ...
                                var o = d.currentStyle, u = s.defaultView, o = (o = o ? o.whiteSpace : u && u.getComputedStyle ? u.getComputedStyle(d, q).getPropertyValue('white-space') : 0) && o.substring(0, 3) === 'pre';
                            }u = j.linenums; if (!(u = u === 'true' || Number(u))) {
                                u = (u = k.match(/\blinenums\b(?::(\d+))?/)) ? u[1] && u[1].length ? Number(u[1]) : !0 : !1; 
                            }u && J(d, u, o); r =
		{h: m, c: d, j: u, i: o}; K(r);
                        }
                    } 
                }i < p.length ? setTimeout(g, 250) : typeof a === 'function' && a(); 

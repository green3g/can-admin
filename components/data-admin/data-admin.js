...
import '../paginate-footer/paginate-footer';
...
import {FilterList} from 'can-admin/components/filter-widget/Filter';
...
export const ViewModel = DefineMap.extend('DataAdmin', {
        ...
        get () {
            ...
            if (this.view.fields) {
                if (this.view.fields.serialize()) {
                    fields = parseFieldArray(this.view.fields.serialize());
                }
            }
    ...
    editObject () {
        ...
        this.setPage('edit', this.view.connection.id(obj));
    },
    /**
    ...
    viewObject () {
        const obj = arguments[arguments.length - 1];
        this.setPage('details', this.view.connection.id(obj));
    },
    /**
     * @description

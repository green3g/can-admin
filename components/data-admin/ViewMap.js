...
export const ViewMap = DefineMap.extend('ViewMap', {seal: false}, {
     ...
     * @property {Boolean} data-admin/ViewMap.props.canDelete canDelete
     * @parent data-admin/ViewMap.props
     */
    canDelete: {value: true},
    /**
     * A flag to disable creating new objects
     * @property {Boolean} data-admin/ViewMap.props.canCreate canCreate
     * @parent data-admin/ViewMap.props
     */
     ...
     */
    afterCreate () {
        message.success(`${this.view.title} was created`);
    },
    /**
     ...
     */
    afterSave () {
        message.success(`${this.view.title} was updated`);
    },
    /**
    ...
    errorDelete () {
        dev.warn(arguments);
        message.error('There was a problem deleting the row.');
    },
    /**
    ...
    errorSave  () {
        dev.warn(arguments);
        message.error('There was a problem saving the row.');
    },
    /**
     * called when the form doesn't validate
     * @property {function data-admin/ViewMap.event.errorSubmit} errorSubmit
     */
    errorSubmit () {
